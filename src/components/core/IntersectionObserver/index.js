// This component is for observing any element visibility. We can use this to lazy load images as well as changing styles and visibility of objects based on the viewport.
// Read more about the Intersection Observer API below.
