...
export const MobileHomeHeroStyle = styled.div`
  width: 100%;
...
MobileHomeHeroStyle.LocationSwitch = styled.div`
  position: relative;
  width: 100%;
  max-width: 100%;
  overflow: hidden;
...
MobileHomeHeroStyle.Tools = styled.div`
  width: 100%;
  padding-left: calc(${Root.Grid.Gutter.Left});
`;

// HomeHero Tools Inner
MobileHomeHeroStyle.ToolsInner = styled.div`
...
// Base transition styles for collapsing HomeHero
MobileHomeHeroStyle.Inner = styled(HeroInnerStyle)`
