// MobileQuestionsHeroStyle Styles:
...
export const MobileQuestionsHeroStyle = styled.div`
  width: 100%;
...
MobileQuestionsHeroStyle.LocationSwitch = styled.div`
  position: relative;
  width: 100%;
  max-width: 100%;
  overflow: hidden;
...
MobileQuestionsHeroStyle.Tools = styled.div`
  width: 100%;
  padding-left: calc(${Root.Grid.Gutter.Left});
`;

// LocationsHero Tools Inner
MobileQuestionsHeroStyle.ToolsInner = styled.div`
...
MobileQuestionsHeroStyle.Inner = styled(HeroInnerStyle)`
